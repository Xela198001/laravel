...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Янв 29 2020 г., 11:36
...
-- База данных: `corp`
--
CREATE DATABASE IF NOT EXISTS `corp` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `corp`;
...
CREATE TABLE `categories` (
  ...
  `title` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `paret_id` int(11) NOT NULL DEFAULT '0',
...
(1, 'Главная', 'about', 0, '2019-09-08 15:16:53', NULL),
(3, 'Блог', 'blog', 0, '2019-09-08 15:16:58', NULL),
(4, 'Портфолио', 'portfolio', 0, '2019-09-08 15:17:00', NULL),
(5, 'Компьютеры', 'computers', 3, '2019-09-08 18:35:21', NULL),
(6, 'Компьютеры', 'computers1', 4, '2019-09-08 18:37:21', NULL),
(7, 'Контакты', 'contacts.php', 0, '2019-09-08 19:00:00', NULL);
...
(66, '2019_09_07_153904_create_articles_table', 1),
(67, '2019_09_07_154018_create_portfolios_table', 1),
(68, '2019_09_07_154129_create_filters_table', 1),
(69, '2019_09_07_154236_create_comments_table', 1),
(70, '2019_09_07_154333_create_sliders_table', 1),
(71, '2019_09_07_154421_create_menus_table', 1),
(72, '2019_09_07_154521_create_categories_table', 1),
(73, '2019_09_07_163710_change_articles_table', 2),
(74, '2019_09_07_164729_change_comments_table', 3),
(75, '2019_09_07_174138_change_portfolios_table', 4);
...
(5, 'port1', 'port1', 'port1', 'port1', '', NULL, NULL, '1');
...
(2, '<h2 style=\"color:#fff\">PINKRIO. <span>STRONG AND POWERFUL.</span></h2>', 'Nam id quam a odio euismod pellentesque. Etiam congue rutrum risus non vestibulum. Quisque a diam at ligula blandit consequat. Mauris ac mi velit, a tempor neque', '00314.jpg', NULL, NULL),
(3, '', '', 'dd.jpg', NULL, NULL);
...
(1, 'Александр Анатольевич Мещеряков', 'mes-aleksandr@yandex.ru', NULL, '$2y$10$sseiJJHgOPjRCauRg.2V1OnToKBjlUdS1wxGGewEkKWQ0QqcZHqpS', NULL, '2019-09-08 03:06:48', '2019-09-08 03:06:48');
